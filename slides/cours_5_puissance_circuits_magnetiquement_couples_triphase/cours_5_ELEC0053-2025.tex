...
\title{\textbf{} ELEC0053 Circuits électriques \\[2mm] --- \\[2mm] 
	Calcul des puissances en régime sinusoïdal établi\\ Circuits magnétiquement couplés\\  
...
\textbf{Dans le syllabus : le reste du chapire 4.}
\end{frame}

\begin{frame}{Exercices que vous devez être capables de résoudre à l'issue de ce cours }

Tous les exercices du chapitre 4 mais plus précisément les exercices 4.6 à 4.15.
...
\begin{frame}{Puissance instantanée}
	...
	\begin{frame}{La puissance instantanée $p(t) = P + p_f(t)$ }
	...
	\begin{frame}{Le facteur de puissance}
	...
	\begin{frame}{Expression de $P$ et $Q$ à partir de l'impédance (admittance) du	dipôle}
	...
	\begin{frame}{Conservation de la puissance complexe}
...
\begin{frame}{Inductances couplées}
	...
	\begin{columns}
		\begin{column}{0.5\linewidth}
			\begin{center}
				\includegraphics[width=0.8\linewidth]{CMC_principe}
			\end{center}
		\end{column}
		\begin{column}{0.5\linewidth}
...
\begin{frame}{Modèle du transformateur idéal}
	...
	\begin{block}{Modèle du transformateur idéal}
		\begin{columns}
			...
			\end{column}
			\begin{column}{0.5\linewidth}
				\includegraphics[width=0.8\linewidth]{transfo_UetI}
			\end{column}
		\end{columns}
	\end{block}	
