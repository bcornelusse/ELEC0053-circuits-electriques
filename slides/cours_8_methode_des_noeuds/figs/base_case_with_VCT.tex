...
\begin{tikzpicture}[american, scale=0.8]
    ...
    \draw (a |- d) -- (c |- d);
    \node[ground] at (d) {};
    \node[below right=2mm] at (d) {\large \textbf{d}};
    ...
    % Résistance G6
    \draw[red] (c) node[circ]{} to[american controlled current source, l_=$g_m u_2$, i=$i_6$, invert] (c |- d) node[circ]{};
    % Source is2
